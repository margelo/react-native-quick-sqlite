...
namespace margelo::nitro::rnquicksqlite {
  ...
  public:
    ...
    std::string columnDeclaredType     SWIFT_PRIVATE;
    double columnIndex     SWIFT_PRIVATE;

  public:
    explicit ColumnMetadata(std::string columnName, std::string columnDeclaredType, double columnIndex): columnName(columnName), columnDeclaredType(columnDeclaredType), columnIndex(columnIndex) {}
  };
  ...
  struct JSIConverter<ColumnMetadata> {
    static inline ColumnMetadata fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return ColumnMetadata(
        ...
        JSIConverter<std::string>::fromJSI(runtime, obj.getProperty(runtime, "columnDeclaredType")),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const ColumnMetadata& arg) {
      ...
      obj.setProperty(runtime, "columnDeclaredType", JSIConverter<std::string>::toJSI(runtime, arg.columnDeclaredType));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::string>::canConvert(runtime, obj.getProperty(runtime, "columnDeclaredType"))) return false;
