...
namespace margelo::nitro::rnquicksqlite {
  ...
  public:
    explicit QueryResult(QueryType queryType, std::optional<double> insertId, double rowsAffected, std::optional<std::shared_ptr<margelo::nitro::rnquicksqlite::HybridSelectQueryResultSpec>> selectQueryResult): queryType(queryType), insertId(insertId), rowsAffected(rowsAffected), selectQueryResult(selectQueryResult) {}
  };
